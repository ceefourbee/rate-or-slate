app.controller("JukeboxController", function ($scope, $http) {
  ...
  $scope.voteUp = function (track) {
    ...
    $scope.updateHistory({ listener: $scope.listener, track: track.name, action: $scope.listener + ' rated ' + track.name });
  };
  ...
  $scope.voteDown = function (track) {
    ...
    $scope.updateHistory({ listener: $scope.listener, track: track.name, action: $scope.listener + ' slated ' + track.name });
  };
  ...
  $scope.getListeners = function(listeners, max) {
